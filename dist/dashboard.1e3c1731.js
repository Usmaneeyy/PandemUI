...
const notificationList = document.querySelector('.notification-list'); // const swup = new Swup();

const date = new Date();
const API_KEY = '505e050c400e4b41872161802211508';
const CITY = 'Karachi';
let notificationData;
const weatherData = fetch(`https://api.weatherapi.com/v1/current.json?key=${API_KEY}&q=${CITY}`).then(res => res.json()).then(data => {
  console.log(data);
