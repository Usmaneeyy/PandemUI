...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/covid.js":[function(require,module,exports) {
...
coronaData.then(response => response.json()).then(res => {
...
function covidGraph(results) {
  ...
  const data = {
    ...
    datasets: [{
      ...
      backgroundColor: ['rgb(153, 102, 255, 0.5)', 'rgb(75, 192, 192, 0.5)', 'rgb(255, 99, 132, 0.5)'],
      borderColor: ['rgb(153, 102, 255)', 'rgb(75, 192, 192)', 'rgb(255, 99, 132)'],
      borderWidth: 5,
      // barThickness: 60,
  ...
  var myChart = new Chart(document.getElementById('covidChart'), config);
}
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/covid.js"], null)
//# sourceMappingURL=/covid.0075f542.js.map